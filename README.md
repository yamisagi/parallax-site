<div align="center">
  ...
  <h3 align="center">Parallax Site</h3>

  <p align="center">
   This repo will include second coding challenge of Full Stack Web Development Bootcamp.
     </p>
...
In this repository, I will make a site with Parallax effect for Full Stack Course. I will use HTML, CSS.
...
- [x] CSS Styling
- [x] Add Images
- [x] Add Parallax Effect with CSS
- [x] Add Card Section & Styling
- [x] Add Footer & Styling
- [x] Add Media Queries
- [x] Add Responsive Design
- [x] Some Refactoring & Styling 
